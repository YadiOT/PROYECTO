...
/**
 * Ventana principal del Sistema de Control y Préstamo de Laboratorios para estudiantes.
 * Ofrece una interfaz moderna, elegante y fácil de usar para visualizar laboratorios, usuarios, equipos y préstamos.
 * Los estudiantes solo pueden ver la información sin opciones de agregar, editar o eliminar.
 *
 * @author DOC
 */
public class Principal3 extends JFrame {
    ...
    public Principal3() {
        setTitle("Sistema de Control y Préstamo de Laboratorios - Estudiante");
        setSize(1000, 600);
    ...
    private JPanel createHeaderPanel() {
        ...
        headerPanel.setBackground(new Color(33, 97, 140)); // Color del encabezado
    ...
    private JPanel createMenuPanel() {
        ...
        buttonPanel.add(createMenuButton("Préstamos", new String[]{"Solicitar Préstamo", "Mis Préstamos"}));
    ...
    private void mostrarContenido(String categoria, String subOpcion) {
        ...
        switch (categoria) {
            ...
            case "Préstamos":
                ...
                } else if (subOpcion.equals("Mis Préstamos")) {
                    contenidoEspecifico = crearPanelMisPrestamos();
                }
                break;
        }
    ...
    private JPanel crearPanelHorarios() {
        JPanel panel = new JPanel();
        panel.setOpaque(false);
        panel.add(new JLabel("Panel de Horarios - Visualización (Implementación Pendiente)"));
        return panel;
    }

    private JPanel crearPanelDocentes() {
        return new PanelDocentes("Estudiante");
    }

    private JPanel crearPanelEstudiantes() {
        return new PanelEstudiantes("Estudiante");
    }

    private JPanel crearPanelMaquinas() {
        JPanel panel = new JPanel();
        panel.setOpaque(false);
        panel.add(new JLabel("Panel de Máquinas - Visualización (Implementación Pendiente)"));
        return panel;
    }
    ...
    private JPanel crearPanelMisPrestamos() {
        JPanel panel = new JPanel();
        panel.setOpaque(false);
        panel.add(new JLabel("Panel de Mis Préstamos - Implementación Pendiente"));
        return panel;
    }
